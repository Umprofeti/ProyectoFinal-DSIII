...
public class frmLobby extends javax.swing.JFrame {
    ...
    ControlDAO controlD = new ControlDAO();
    ...
    private void initComponents() {
        ...
        jLabel33.setFont(new java.awt.Font("Roboto Black", 0, 16)); // NOI18N
        jLabel33.setText("Fecha ingreso");

        cbAnioUsuario.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Año", "1940", "1941", "1942", "1943", "1944", "1945", "1946", "1947", "1948", "1949", "1950", "1951", "1952", "1953", "1954", "1955", "1956", "1957", "1958", "1959", "1960", "1961", "1962", "1963", "1964", "1965", "1966", "1967", "1968", "1969", "1970", "1971", "1972", "1973", "1974", "1975", "1976", "1977", "1978", "1979", "1980", "1981", "1982", "1983", "1984", "1985", "1986", "1987", "1988", "1989", "1990", "1991", "1992", "1993", "1994", "1995", "1996", "1997", "1998", "1999", "2000", "2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022" }));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 50, 110, 30));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 290, 80, 30));
        ...
        jmCrearUsuario.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jmCrearUsuarioMouseClicked(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
        ...
        jmCrearPlanilla.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jmCrearPlanillaMouseClicked(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
    ...
    public void actualizarTblPlanila() {
        ...
        listaplanilla = controlD.seleccionarPlanillaTotales();
    ...
    private void jmCrearPlanillaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jmCrearPlanillaMouseClicked
        // TODO add your handling code here:
        this.setSize(485, 400);
        this.setLocationRelativeTo(null);
    }//GEN-LAST:event_jmCrearPlanillaMouseClicked

    private void jmVerEmpleadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jmVerEmpleadoMouseClicked
        // TODO add your handling code here:
        this.reiniciarCampos();
        this.vaciarCampos();
        this.setSize(970, 710);
        this.setLocationRelativeTo(null);
    }//GEN-LAST:event_jmVerEmpleadoMouseClicked

    private void jmCrearUsuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jmCrearUsuarioMouseClicked
        // TODO add your handling code here:
        this.setSize(970, 710);
        this.setLocationRelativeTo(null);
    }//GEN-LAST:event_jmCrearUsuarioMouseClicked
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        planilacompleta pc = new planilacompleta();
        pc.setVisible(true);
